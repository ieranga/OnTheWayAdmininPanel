        ...
        <div class="content">
            <div class="cards">
                <div class="card">
                    <div class="icon-case">
                        <div class="allset">
                            <img src="icons8-user-account-60.png" alt="">
                        </div>
                        <div class="allset">
                            <h2>All users</h2>
                        </div>
                ...
                <div class="card">
                    <div class="icon-case">
                        <img src="icons8-product-50.png" alt="">
                        <h2>Products & catagary</h2>
                    </div>
                    <div class="box">
                        <div class="allset">
                            <div class="allset1">
                ...
                <div class="card">
                    <div class="icon-case">
                        <img src="icons8-select-users-48.png" alt="">
                        <h2>Manage users</h2>
                    </div>
                    <div class="box">
                        <div class="allset">
                ...
                <div class="card">
                    <div class="icon-case">
                        <img src="icons8-product-management-50.png" alt="">
